...
const ApplicationContent = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <h1 className="text-2xl font-bold text-center">Your application has been submitted!</h1>
      <br />
      <p className='text-centre'> We will perform some checks on your provided information, this can take upto 48 hours</p>
      <br />
      <p className="text-center">We will get back to you with the decision!</p>
      <br />

...
const ConsultPage = () => {
  ...
  const description = "Select an expert and book your consultation time.";
<Breadcrumb pageName={pageName} description={description} />
  ...
  const handleSelectExpert = (expert) => {
    setSelectedExpert(expert); // Store selected expert
    router.push(`/consult?expertId=${expert.id}`); // Navigate to consult page with expert ID
  };
  ...
  return (
    <div>
      <Header />
      <ExpertsPage onSelectExpert={handleSelectExpert} />
    </div>
  );
};
<section>

            ...
            <div className="max-w-[470px]">
              <div className="mb-9">
                ...
                <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  AeroCOG was founded in 2022 by Pranav PD and Syed Yusuf, with a mission to revolutionize the aerospace industry by connecting aspiring individuals with seasoned experts. 
